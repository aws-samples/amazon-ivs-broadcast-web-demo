...
export default function Settings({
  ...
  // const [localVideoMirror, setLocalVideoMirror] = useState(defaultVideoMirror);
  // const [localOrientation, setLocalOrientation] = useState(defaultOrientation);
  ...
  const handleMirrorVideo = (checked) => {
    setLocalVideoMirror(checked);
  };
  ...
  const handleLocalOrientationChange = (e) => {
    setLocalOrientation(e.target.value);
  };
